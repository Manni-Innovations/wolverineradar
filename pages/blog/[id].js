        ...
        <section className="p-3">
          <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8  border-4 rounded-lg">
            <div className="max-w-3xl">
              <h2 className="text-3xl font-bold sm:text-4xl text-txt">Post not found!</h2>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="lg:py-0">
                <article className="space-y-4 text-white_txt">
                  <br />
                  <p>
                    Oops! It seems like the blog post you were looking for isn&apos;t here. But don&apos;t worry, there
                    are plenty of other exciting posts to explore on our site.
                  </p>
                  <br />
                  <p>
    ...
    <div className="p-3 mt-20 bg-black">
      ...
      <section className="p-3">
        <div className="mx-auto max-w-screen-xl px-8 py-16 sm:px-6 sm:py-12 lg:px-8 border border-gray-200 text-white_txt rounded-lg">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-bold sm:text-4xl text-logo_blue">{blog.title}</h2>
          </div>
...
export async function getStaticPaths() {
  const blogIds = blogPostsData.map((post) => ({ params: { id: post.id.toString() } }));
...
export async function getStaticProps({ params }) {
  const blog = blogPostsData.find((post) => post.id === parseInt(params.id));
